...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','be.k0suke.ticookies.js')
	...
	f = os.path.join(cwd,'Classes','BeK0sukeTicookiesModuleAssets.mm')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','be.k0suke.ticookies.js']
